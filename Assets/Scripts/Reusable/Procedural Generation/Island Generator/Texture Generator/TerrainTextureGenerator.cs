...
namespace ProceduralGeneration.IslandGenerator
{
	...
	class TerrainTextureGenerator
	{
		...
		public TerrainTextureGenerator(List<TerrainNode> terrainNodes, List<Color[]> terrainNodesHeightMaps,
			List<TerrainType> terrainTypes, float blendingHeight)
		{
		...
		{
			List<TerrainType> ascendingTerrainType =
				terrainTypes.OrderBy(terrainType => terrainType.StartingHeight).ToList();
		...
		/// </summary>
		private TerrainBlend GetTerrainTypeBlend(TerrainType below, TerrainType current, TerrainType above,
			float height)
		{
