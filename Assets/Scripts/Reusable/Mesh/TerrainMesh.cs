...
//	public TerrainMesh(GameObject parent, HeightMap heightMap, Vector3 dimensions, Vector2Int verticesCount)
//	{
//		// Height Map
//		HeightMap = heightMap;
...
//		{
//			float pixelsPerVertex = (float)HeightMap.Texture.width / (float)VerticesCount.x;
//			int pixelX = (int)(pixelsPerVertex * (i % VerticesCount.x));
//			int pixelY = (int)(pixelsPerVertex * (i / VerticesCount.x));
//			Color heightMapColor = HeightMap.Texture.GetPixel(pixelX, pixelY);
