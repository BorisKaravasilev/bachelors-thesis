...
public class TerrainNode
{
	...
	public PixelBoundingBox GetPixelBoundingBox(int resolution, float areaRadius)
	{
		...
		Vector2Int areaPixelBottomLeft = TextureFunctions.LocalPositionToPixel(areaLocalBottomLeft, resolution, areaRadius);
		Vector2Int areaPixelTopRight = TextureFunctions.LocalPositionToPixel(areaLocalTopRight, resolution, areaRadius);
